      ...
      try {
        ...
        if (!expressCheckoutElement && elements) {
          try {
            ...
            // First check what element types are available
            console.log('Available Stripe Element types:', elements);
            
            // Use type assertion to bypass TypeScript limitations
            expressCheckoutElement = elements.create('expressCheckout' as any);
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div 
                ...
                style={{ 
                  minHeight: '100px', 
                  width: '100%', 
                  border: elementReady ? 'none' : '1px dashed #ccc',
                  padding: '10px',
                  borderRadius: '8px'
                }}
              ></div>
